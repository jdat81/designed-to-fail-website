...
function TrustDeclineThumbnail() {
  ...
  return (
    <div className="w-full h-full bg-gradient-to-br from-slate-100 to-slate-50 flex items-center justify-center p-4">
      <div className="w-full max-w-[180px]">
        <svg viewBox="0 0 120 80" className="w-full h-auto">
          {/* Grid */}
          <line x1="10" y1="10" x2="10" y2="70" stroke="#cbd5e1" strokeWidth="1" />
          <line x1="10" y1="70" x2="110" y2="70" stroke="#cbd5e1" strokeWidth="1" />
          ...
          <circle cx="10" cy={80 - points[0].y} r="4" fill="#1e3a5f" />
          <circle cx="110" cy={80 - points[4].y} r="4" fill="#1e3a5f" />

          {/* Labels */}
          <text x="10" y={80 - points[0].y - 6} textAnchor="middle" className="text-[8px] font-bold" fill="#1e3a5f">73%</text>
          <text x="110" y={80 - points[4].y + 12} textAnchor="middle" className="text-[8px] font-bold" fill="#1e3a5f">30%</text>
        </svg>
        <div className="text-center">
          <span className="text-[10px] font-semibold text-slate-700">Trust Collapse 1958-78</span>
        </div>
      </div>
    </div>
  )
