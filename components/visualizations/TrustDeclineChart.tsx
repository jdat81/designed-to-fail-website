...
export default function TrustDeclineChart() {
  ...
  return (
    <div className="w-full">
      ...
      {/* Chart */}
      <div className="relative h-80 bg-gradient-to-b from-red-50 to-white rounded-xl p-6 overflow-visible">
        {/* Y-axis labels */}
        ...
        {hoveredIndex !== null && (
          <div
            className="absolute px-3 py-2 bg-white border border-red-200 rounded-lg shadow-lg z-10 pointer-events-none"
            style={{
              left: `calc(3rem + ${(hoveredIndex / (trustData.length - 1)) * 100}% - 40px)`,
              bottom: '3rem'
            }}
          >
            <div className="font-bold text-red-600">{trustData[hoveredIndex].year}</div>
      ...
      <div className="grid grid-cols-3 gap-4 mt-6">
        ...
        <div className="bg-red-50 rounded-xl p-4 text-center border-t-4 border-red-700">
          <div className="text-3xl font-bold text-red-800">-43pts</div>
